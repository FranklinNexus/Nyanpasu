...
class MainActivity : AppCompatActivity() {
    ...
    private val mascotQuotes = listOf(
        ...
        "Happy to see you again! 😊", "The world is beautiful today! 🌸",
        
        // Motivation
        "You are doing great! 👍", "Believe in yourself! 🌟", "Keep pushing forward! 🚀",
        "Small steps lead to big dreams! 👣", "Don't forget to smile! 😄", "You look kawaii today! 🥰",
        "Sending you positive vibes! 📡", "Everything will be daijoubu! 👌",
        "Your potential is infinite! ♾️", "Stay hydrated! 💧", "Take a deep breath~ 🍃",
        
        // ACG & Anime
        "Need a new waifu? 🔍", "Explosion!! 💥", "El Psy Kongroo. 📱",
        "Isekai portal opening... 🌀", "Nico Nico Nii~ 🤟", "Just according to keikaku. 📝",
        "Super Saiyan mode: ON! 🔥", "Notice me, Senpai! 👀", "Bankai! 🗡️",
        "The moon is beautiful, isn't it? 🌙", "Moe power charging... 🔋",
        "Yamete kudasai! 🙈", "Nani?! 😲", "Sugoi desu ne! ✨", "Ganbatte! 💪",
        "Itadakimasu! 🍜", "Ara ara~ 😏", "Umu! 👸",
        
        // Tech & Geek
        "No bugs today, please! 🐞", "Compiling happiness... ⏳", "Git push your dreams! ⬆️",
        "Coffee: 100%. Energy: 100%. ☕", "404: Sadness not found. 🚫", "Sudo make me a sandwich. 🥪",
        "Hello World! 🌍", "Refreshing cache... 🔄", "Strict mode is best mode. 🔒",
        "while(alive) { code(); } 💻", "Error 418: I'm a teapot. 🫖",
        "Debugging life... 🔍", "Stack overflow? Stack hugs! 🤗", "const happiness = true; 😊",
        "Blue mode is cool! 💙", "Pink mode is cute! 💖",
        
        // Cute Actions
        "Pat pat~ (｡•̀ᴗ-)✧", "Meow? 🐱", "Waku waku! ⭐", "Cheer up! 🌈",
        "Loading cuteness... [||||||] 100%", "Hugs incoming! 🫂", "*Stares politely* 😶",
        "Boop! 👆", "Zzz... 💤", "*Nods enthusiastically* 👀",
        "*Spins around* 💫", "*Waves* 👋", "Chu~ 💋", "Ehehe~ 😊", "Nya nya~ 🐾",
        
        // Random Fun
        "RNG favors the brave! 🎲", "Gacha luck +100! 🍀", "Critical hit! 💥",
        "Achievement unlocked! 🏆", "Level up! ⬆️", "New quest available! 📜",
        "Inventory full! 🎒", "Save point reached! 💾", "Boss music starts... 🎵", "Respawning... ⏳",
