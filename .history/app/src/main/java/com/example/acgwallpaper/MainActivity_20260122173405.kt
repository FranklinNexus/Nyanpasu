...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupPreviewAspectRatio() {
        ...
        // 2. 构建 ConstraintLayout 所需的比例字符串
        // 格式为 "W:H" (例如 "1080:2400")
        // 配合 XML 中的 layout_width="0dp" 和 layout_height="0dp"，它会根据约束自动计算匹配此比例的尺寸
        val ratioString = "$screenWidth:$screenHeight"

        // 3. 获取卡片的布局参数并修改
        val params = binding.previewCard.layoutParams as ConstraintLayout.LayoutParams
        ...
        // (可选) 打印日志看看比例对不对
        // android.util.Log.d("NyanpasuRatio", "Screen ratio applied: $ratioString")
    }
